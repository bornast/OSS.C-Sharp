...
namespace Labs
{
	...
	public class AppForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.AppForm_Close);
		...
		private void AppForm_Load(object sender, EventArgs e)
		{
			...
			var formWindow = (FormWindow)DeserializeObjectFromFile(path);
